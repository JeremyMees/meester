...
// Query: *[_type == "translation.metadata"] {    "translations": translations[defined(value->slug.current)] {      "_id": value->_id,      "slug": value->slug.current,      "language": value->language    }  }
export type MetadataQueryResult = Array<{
  translations: Array<{
    _id: null | string
    slug: string | null
...
// Source: ../web/shared/utils/sanity-queries.ts
// Variable: unlinkedQuery
// Query: *[    _type in ["page", "policy"] &&    defined(slug.current) &&    !(_id in $linkedIds)  ] {    _id,    "slug": slug.current,    language  }
export type UnlinkedQueryResult = Array<{
  _id: string
  slug: string | null
